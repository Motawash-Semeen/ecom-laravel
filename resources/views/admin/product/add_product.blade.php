                        ...
                        <div class="box-body pb-0">
                            <form action="{{ url('admin/product/add') }}" method="post" enctype="multipart/form-data">
                                                    ...
                                                    @foreach ($subsubcategories as $subsubcategory)
                                                        @if ($subsubcategory->subcategory_id == $product->subcategory_id)
                                                            <option value="{{ $subsubcategory->id }}"
                                                                @if (isset($product) && $product->subsubcategory_id == $subsubcategory->id) selected @endif>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="product_name_en" class="form-control"
                                                    value="{{ isset($product->id) ? $product->product_name_en : '' }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="product_code" class="form-control"
                                                    value="{{ isset($product->id) ? $product->product_code : '' }}">
                                                <div class="help-block"></div>
                                            </div>
                                            @error('product_code')
                                                <div class="form-control-feedback text-danger">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="product_qty" class="form-control"
                                                    value="{{ isset($product->id) ? $product->product_qty : '' }}">
                                                <div class="help-block"></div>
                                            </div>
                                            @error('product_qty')
                                                <div class="form-control-feedback text-danger">
                                            ...
                                            <div class="controls">
                                                <div class="tags-default bg-transparent">
                                                    <input type="text" data-role="tagsinput"
                                                        class="form-control productTags" id="productTags"
                                                        placeholder="add tags" name="product_tags_en"
                                                        value="{{ isset($product->id) ? $product->product_tags_en : old('product_tags_en') }}" />
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            <h5>Product Tag(bn) <span class="text-danger">*</span><small>Comma
                                                    Separeted.</small></h5>
                                            <div class="controls">
                                                <div class="tags-default bg-transparent">
                                                    <input type="text"
                                                        value="{{ isset($product->id) ? $product->product_tags_bn : old('product_tags_bn') }}"
                                                        data-role="tagsinput" class="form-control productTags"
                                                        id="productTagsBn" placeholder="add tags"
                                                        name="product_tags_bn" />
                                                </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <div class="tags-default bg-transparent">
                                                    <input type="text"
                                                        value="{{ isset($product->id) ? $product->product_size_en : 'small,large,medium' }}"
                                                        data-role="tagsinput" class="form-control productTags"
                                                        id="productTags" placeholder="add tags" name="product_size_en" />
                                                </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <div class="tags-default bg-transparent">
                                                    <input type="text"
                                                        value="{{ isset($product->id) ? $product->product_size_bn : 'ছোট,বড়,মধ্যম' }}"
                                                        data-role="tagsinput" class="form-control productTags"
                                                        id="productTags" placeholder="add tags" name="product_size_bn" />
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            <h5>Product Color(en) <span class="text-danger">*</span><small>Comma
                                                    Separeted.</small></h5>
                                            <div class="controls">
                                                <div class="tags-default bg-transparent">
                                                    <input type="text"
                                                        value="{{ isset($product->id) ? $product->product_color_en : 'black,red,white' }}"
                                                        data-role="tagsinput" class="form-control productTags"
                                                        id="productTags" placeholder="add tags"
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            <h5>Product Color(bn) <span class="text-danger">*</span><small>Comma
                                                    Separeted.</small></h5>
                                            <div class="controls">
                                                <div class="tags-default bg-transparent">
                                                    <input type="text"
                                                        value="{{ isset($product->id) ? $product->product_color_bn : 'কালো,সাদা,লাল' }}"
                                                        data-role="tagsinput" class="form-control productTags"
                                                        id="productTags" placeholder="add tags"
                                                        name="product_color_bn" />
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="selling_price" class="form-control"
                                                    value="{{ isset($product->id) ? $product->selling_price : old('selling_price') }}">
                                                <div class="help-block"></div>
                                            </div>
                                            @error('selling_price')
                                                <div class="form-control-feedback text-danger">
                                ...
                                <div class="row">
                                            ...
                                            <div class="controls">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" aria-invalid="false"
                                                        name="discount_price"
                                                        value="{{ isset($product->id) ? $product->discount_price : old('discount_price') }}">
                                    ...
                                    <div class=" col-12 {{ isset($product->id) ? 'col-md-6' : 'col-md-4' }}">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="file" name="product_thambnail" class="form-control"
                                                    aria-invalid="false" id="productThambnail">
                                                <div class="help-block"></div>
                                            </div>
                                        ...
                                        <img id="showImage"
                                            @if (isset($product->product_thambnail)) src="{{ asset('upload/products/' . $product->product_thambnail) }}" 
                                            style="width:60px; height:60px" @endif>
                                    </div>
                                    @if (!isset($product->id))
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="file" name="file[]" class="form-control"
                                                        aria-invalid="false" id="multiImg" multiple="">
                                                    <div class="help-block"></div>
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="editor1" name="long_descp_en" rows="10" cols="80" placeholder="">{{ isset($product->id) ? $product->long_descp_en : old('long_descp_en') }}</textarea>
                                            @error('long_descp_en')
                                                <div class="form-control-feedback text-danger">
                                                    <small>{{ $message }}</small></div>
                                            @enderror
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="editor2" name="long_descp_bn" rows="10" cols="80" placeholder="">{{ isset($product->id) ? $product->long_descp_bn : old('long_descp_bn') }}</textarea>
                                            @error('long_descp_bn')
                                                <div class="form-control-feedback text-danger">
                                                    <small>{{ $message }}</small></div>
                                            @enderror
                                            ...
                                            <div class="controls">
                                                <fieldset>
                                                    <input type="checkbox" id="checkbox_2" name="hot_deals"
                                                        value="1" @if (isset($product->hot_deals) && $product->hot_deals == 1) checked @endif>
                                                    <label for="checkbox_2">Hot Deals</label>
                                                </fieldset>
                                                <fieldset>
                                                    <input type="checkbox" id="checkbox_3" value="1"
                                                        name="featured" @if (isset($product->featured) && $product->featured == 1) checked @endif>
                                            ...
                                            <div class="controls">
                                                <fieldset>
                                                    <input type="checkbox" id="checkbox_4" value="1"
                                                        name="special_offer"
                                                        @if (isset($product->special_offer) && $product->special_offer == 1) checked @endif>
                                                    <label for="checkbox_4">Special Offer</label>
                                                </fieldset>
                                                <fieldset>
                                                    <input type="checkbox" id="checkbox_5" value="1"
                                                        name="special_deals"
                                                        @if (isset($product->special_deals) && $product->special_deals == 1) checked @endif>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box bt-3 border-info">
                            ...
                            <div class="box-body">
                                <form action="{{ url('admin/product/multiImg/update') }}" method="POST"
                                    ...
                                    <div class="row row-sm" id="rowMulti">
                                        ...
                                        @foreach ($multiImg as $img)
                                            <div class="col-md-3">
                                                <div class="card">
                                                    <img src="{{ asset('upload/products/' . $img->photo_name) }}"
                                                        class="card-img-top" alt="..." height="130px"
                                                        width="280px">
                                                    <div class="card-body">
                                                        <h5 class="card-title">
                                                            <a href="{{ url('admin/product/multiImg/delete/' . $img->id) }}"
                                                                class="btn btn-danger btn-sm" id="delete"
                                                                title="Delete this"><i class="fa fa-trash"></i></a>
                                                        </h5>
                                                        <p class="card-text">
                                                        <div class="form-group">
                                                            <label for="" class="form-control-label">Change
                                                                Image</label>
                                    ...
                                    <div class="text-center d-flex align-items-center justify-content-center"
                                        ...
                                        <button type="button"
                                            ...
                                            title="Add New Image" id="addImage">Add New Image</button>
                                    </div>
