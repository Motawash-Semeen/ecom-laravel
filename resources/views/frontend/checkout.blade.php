                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6 already-registered-login">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    class="form-control unicase-form-control text-input"
                                                    id="inputPhone" name="address" placeholder="Dhaka, Bangladesh">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-6 already-registered-login">
                                            <div class="form-group">
                                                  ...
                                                  <table class="table">
                                                    <thead>
                                                      <tr>
                                                        ...
                                                        <th class="cart-product-name item text-center">Product Name</th>
                                                        <th class="cart-qty item text-center">Quantity</th>
                                                        <th class="cart-sub-total item text-center">Unit Price</th>
                                                        <th class="cart-total last-item text-center">Total</th>
                                                      </tr>
                                                    </thead><!-- /thead -->
                                                    <tfoot>
                                                        <tr>
                                                    ...
                                                    <tbody>
                                                      ...
                                                      @foreach ($carts as $cart)
                                                          <tr>
                                                            <td>
                                                                <img src="{{ asset('upload/products/'.$cart->options->image) }}" alt="" style="height: 50px; width: 60px;">
                                                            </td>
                                                            <td>
                                                                <a href="">{{ $cart->name }}</a>
                                                                <br>
            ...
            if (city_id != null) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(key, v) {
                            html += '<option value="' + v.id + '">' + v.post_office_name +
                                '</option>';
                        });
                        $('#inputArea').html(html);
                    }
